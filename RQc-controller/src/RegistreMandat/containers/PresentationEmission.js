...
import PresentationEmissionForm         from '../components/PresentationEmissionForm';
import Success                          from '../../assets/images/success.png';
import                                       '../../assets/styles/ProofContainer.css';

const PresentationEmission = (props) => {
    ...
    return (
        <Container className="my-5">
            <Row form>
                <PresentationEmissionForm data={props.location.state} />
...
export default PresentationEmission;
