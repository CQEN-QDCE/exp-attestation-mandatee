...
function VerificationResponsable(props) {
    ...
    const VerifyPresentation = (presentation_exchange_id) => {
        fetch('/present-proof/records/' + presentation_exchange_id + '/verify-presentation', 
         ...
         .then(data => {
            ...
            props.history.push('/qrmandatcuratelle', {
    ...
    return (
        <Container className="mt-5 pt-5">
            ...
            <div className="text-center FormBox mt-5 pt-5">
                <h3 className="mb-5 pb-4 mt-2 header"> {t('identite:lblVerification')} - 1ère étape </h3>
                <br />
                <p>
                    <h3>Vérification d'identité du responsable</h3>
                    <h4> Veuillez attendre à la présentation de preuve de l'attestation d'identité par le citoyen. </h4>
...
export default VerificationResponsable;